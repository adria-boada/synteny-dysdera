...
# angsd output folder
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
out_name=${3##*/}_mn$4_mx$5_sites
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

outfolder=output/${out_name}_dir
mkdir -p $outfolder
...
# scaffold of interest: A chromosome name
# Assigna la 1era columna del fitxer $3 com a scaffold
# És a dir, assigna el nom de cromosoma del fitxer sites.
scf_id=`cut -f1 $3 | uniq`

# Sites of interest: A -sites formatted file.
sites=$3
