...
bash Submissio/angsd_theta.sh Data/Deng_reads.bam Data/Dsil_genome.fasta $1 7 37
bash Submissio/angsd_theta.sh Data/Deng_reads.bam Data/Dsil_genome.fasta $1 5 19
bash Submissio/angsd_theta.sh Data/Deng_reads.bam Data/Dsil_genome.fasta $1 18 28
bash Submissio/angsd_theta.sh Data/Deng_reads.bam Data/Dsil_genome.fasta $1 10 15
