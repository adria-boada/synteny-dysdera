...
# UPDATED # qsub -cwd -V -N 'chr_U1' -j y -q h11.q -l hostname=hercules11 -pe ompi64h11 24 -b y bash angsd_theta.sh Deng_reads.bam Dsil_genome.fasta U1 10 50



## SOFT path
path_angsd_H=/soft/angsd
path_angsd_A=/home/adria/Angsd/angsd
...
# angsd output folder
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
out_name=chr$3_mn$4_mx$5
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

outfolder=output/${out_name}
mkdir -p $outfolder
...
if [ $3 = X ]
then
    scf_id=Scaffold_15362_HRSCAF_19823 # Chr X
elif [ $3 = 1 ]
then
    scf_id=Scaffold_14804_HRSCAF_18385 # Chr 1
elif [ $3 = U1 ]
then
    scf_id=Scaffold_13616_HRSCAF_15698 # Chr U1
elif [ $3 = U2 ]
then
    scf_id=Scaffold_15360_HRSCAF_19821 # Chr U2
else
    echo "ERROR: Not a single Scaffold of Interest was selected!"
    exit 1
fi
...
$path_angsd/angsd \
  -GL 2 \
  -out $ofolder/$out_name.$scf_id.glftest \
  -nThreads $ncpu \
  -doSaf 1 \
  -doCounts 1 \
  -doGlf 4 \
...
$path_angsd/misc/realSFS print $ofolder/$out_name.$scf_id.glftest.saf.idx -r $scf_id > $ofolder/$out_name.$scf_id.glftest.saf.idx.txt
fi
...
### global theta, given one regions and one scaffold
...
#~    -P $ncpu \
#~    -r $scf_id:1-100003 \
#~    -outname $outfolder/$out_name.glob.region.theta_per_site \
#~    -sfs $outfolder/$out_name.glob.sfs # unfolded SFS
...
$path_angsd/misc/thetaStat print $outfolder/$out_name.glob.theta_per_site.thetas.idx > $ofolder/$scf_id.globthetas.txt
